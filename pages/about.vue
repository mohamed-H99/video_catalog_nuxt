<template>
  <div class="page-wrap mx-auto">
    <div class="position-relative">
      <!-- navbar -->
      <app-navbar />
      <div class="welcome-container fixed-header fixed-header-2">
        <div class="text-center">
          <p
            class="pt-5 px-3 welcome-text welcome-text-2 mb-1 mt-lg-0 mt-5 text-white mx-auto"
          >
            Another Image BG<br />it can be fixed.<br />Content will simply
            slide over.
          </p>
        </div>
      </div>
    ...
    <main>
      <div class="container-fluid px-0">
          ...
          <div class="row mt-3 mb-5 pb-3">
            <div class="col-12">
              <div class="mx-auto about-text-container px-3">
                <h2 class="page-title mb-4 text-primary">
                ...
                <p class="mb-4">
                  ...
                  <a href="https://github.com/mohamed-H99" class="text-primary"
                    >Our Projects</a
                  >, please contact us.
                </p>
                <p class="mb-4">
        ...
        <div
          ...
          data-image-src="~/assets/img/about-2.jpg"
        >
          <img src="~/assets/img/about-2.jpg" alt="Image" />
        </div>

        <div class="mx-auto content-container mt-4 px-3">
          <div class="row catalog-item-list mb-4">
            <div class="col-lg-4 col-md-6 col-sm-12 catalog-item">
              <div class="bg-gray p-4">
                <i class="fas fa-headphones fa-5x p-3 mb-4 about-icon"></i>
                <h3 class="text-primary mb-3">Cras convallis mollis justo</h3>
                <p>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 catalog-item">
              <div class="bg-gray p-4">
                <i class="fas fa-broadcast-tower fa-5x p-3 mb-4 about-icon"></i>
                <h3 class="text-primary mb-3">Nullam dictum pretium</h3>
                <p>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 catalog-item">
              <div class="bg-gray p-4">
                <i class="fas fa-film fa-5x p-3 mb-4 about-icon"></i>
                <h3 class="text-primary mb-3">Etiam in quam dolor</h3>
                <p>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 catalog-item">
              <div class="bg-gray p-4">
                <i class="far fa-map fa-5x p-3 mb-4 about-icon"></i>
                <h3 class="text-primary mb-3">Duis ornare felis nec orci</h3>
                <p>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 catalog-item">
              <div class="bg-gray p-4">
                <i class="fas fa-rainbow fa-5x p-3 mb-4 about-icon"></i>
                <h3 class="text-primary mb-3">Class aptent taciti sociosqu</h3>
                <p>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 catalog-item">
              <div class="bg-gray p-4">
                <i class="fas fa-cloud-sun-rain fa-5x p-3 mb-4 about-icon"></i>
                <h3 class="text-primary mb-3">Suspendisse ut malesuada</h3>
                <p>
        ...
        <div
          class="parallax-window"
          data-parallax="scroll"
          data-image-src="~/assets/img/about-3.jpg"
        >
    ...
    <div class="container-fluid content-container mx-auto pt-5">
      <!-- footer -->
    </div>
  </div>
</template>
